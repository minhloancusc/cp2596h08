 ...
 * @author minhloan
 */
public class Example3TagHandler extends BodyTagSupport {
    ...
    public int doAfterBody() throws JspException {
        try {
            ...
            JspWriter out = bodyCont.getEnclosingWriter();
             String bodyStr = "<img src='"+bodyContent.getString()+"' width='"+width+"'/>"+slogan.toUpperCase();            
             out.print(bodyStr);
    ...
    private void handleBodyContentException(Exception ex) throws JspException {
        ...
        throw new JspException("Error in Example3TagHandler tag", ex);
    }
