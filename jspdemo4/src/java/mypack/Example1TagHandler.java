 ...
 * @author minhloan
 */
public class Example1TagHandler extends BodyTagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        try {
            JspWriter out = pageContext.getOut();
            out.println("Result: "+ (param1+param2));
        } catch (IOException ex) {
            // do something
        }
    ...
    private void handleBodyContentException(Exception ex) throws JspException {
        ...
        throw new JspException("Error in Example1TagHandler tag", ex);
    }
