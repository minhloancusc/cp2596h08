 ...
 * @author minhloan
 */
public class Example2TagHandler extends BodyTagSupport {

    /**
     * Creates new instance of tag handler
     */
    public Example2TagHandler() {
        super();
    }
    ...
    public int doAfterBody() throws JspException {
        try {
            ...
            String bodyStr = "<img src='"+bodyContent.getString()+"'/>";
    ...
    private void handleBodyContentException(Exception ex) throws JspException {
        ...
        throw new JspException("Error in Example2TagHandler tag", ex);
    }
